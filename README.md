...
matching request ex: /api/v1/users/1/, /api/v1/users/a11111/ ... etc

path: /api/v1/users/{:id}/name/
matching request ex: /api/v1/users/1/name/, /api/v1/users/a11111/name/ ... etc

path: /api/v1/users/{:id}/bools/{:book_id}
ex matching request: /api/v1/users/1/bools/b2222/, /api/v1/users/a11111/bools/b3333/ ... etc

path: /api/v1/users?id={:id}
matching request ex: /api/v1/users?id=1, /api/v1/users?id=a11111 ... etc
```
